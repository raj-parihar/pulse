...
<div class="topnav">
  ...
  <a href="dir.php"><div class="w3-xxlarge"><i class="fa fa-bar-chart"></i></font></div></a>
  ...
  <div class="topnav-right">
    ...
    <a href="about.php"><div class="w3-xxlarge"><i class="fa fa-users"></i></div></a>
	  ...
	  <center>
		   <font size="50" face="georgia"><font color="darkviolet"><b>NRU:</b></font> Complete Data </font> 
	  <br><br>
...
<table id="cities" align="center">
    		<th colspan=5><center>NRU data (A-Z)</center></th>
		<tbody>
<?php

		if ($access == "admin123") {
                        echo "<tr><td>Name</td><td>Email</td>";
                        echo "<td>Phone</td><td>Location</td><td>State</td></tr>";
		while ($row = mysqli_fetch_array($query))
		{
			...
			$name = $row['name'];
                        echo "<tr><td>".$name."</td><td>$email</td>";
                        echo "<td>".$phone."</td>";
                        echo "<td>".$loc."</td><td>$state</td></tr>";
		}}
		else {
			echo "Unathorized access. Your IP address is recorded!\n";
			}
